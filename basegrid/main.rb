    ...
    def sync_materials
      ...
      if token.empty?
        answer = UI.messagebox(
          "This SketchUp installation is not connected to the Materials web app. Open the connection page now?",
          MB_YESNO
        )
        open_material_connections if answer == IDYES
        return
      end
