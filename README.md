...
Restart SketchUp after installing the loader. The commands appear under **Extensions > Basegrid**. **Materials > Connect** opens the browser-based OAuth connection. **Connect with Token** remains available during migration.
